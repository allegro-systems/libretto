...
struct EditorPage: Page {
    ...
    var body: some Node {
        Stack {
            ...
            .size(height: 36)
            .background(.surface)
            .htmlAttribute("style", "border-top:1px solid var(--color-border)")
    ...
    private func toolbarButton(id: String, icon: String, title: String) -> some Node {
        ...
        .border(width: 1, color: .border, style: .solid)
        .radius(4)
        .htmlAttribute("style", "cursor:pointer;display:inline-flex;align-items:center;justify-content:center;")
